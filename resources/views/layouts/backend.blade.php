...
<head>
    ...
    <title>Quản trị hệ thống - CMVKC</title>
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
        ...
        {{-- Nhúng mã của khu vực Top header (layouts/includes/admin/topheader.blade.php) vào đây. --}}
        @include('layouts.includes.admin.topheader')
        

        {{-- Nhúng mã của khu vực Left Side Menu (layouts/includes/admin/leftsidemenu.blade.php) vào đây. --}}
        @include('layouts.includes.admin.leftsidemenu')
        ...
        <div class="page-wrapper">
            ...
            {{-- Nhúng mã của khu vực Footer (layouts/includes/admin/footer.blade.php) vào đây. --}}
