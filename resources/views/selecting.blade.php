		...
		<header id="header">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="{{ route('home') }}" class="standard-logo" data-dark-logo="images/logo.png" data-sticky-logo="images/logotext.png" data-mobile-logo="images/logotext.png"><img src="images/logo.png" alt="Canvas Logo"></a>
						<a href="{{ route('home') }}" class="retina-logo" data-dark-logo="images/logo.png" data-sticky-logo="images/logo.png" data-mobile-logo="images/logotext.png"><img src="images/logotext.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu">
						...
						<ul>
							<li class="current"><a href="{{ route('home') }}"><div>Trang chủ</div></a></li>
