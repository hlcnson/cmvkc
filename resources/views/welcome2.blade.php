			...
			<div class="slider-parallax-inner">
				...
				<div class="container clearfix">
					<div class="vertical-middle dark center">
						...
						<a href="#" class="button button-border button-light button-rounded button-reveal tright button-large topmargin d-none d-md-inline-block"><i class="icon-angle-right"></i><span>Tìm hiểu ngay</span></a>
